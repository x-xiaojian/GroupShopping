  ...
  <tr>
    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
      ...
      AfficheForm form=(AfficheForm)list.get(i);
          %>
        <tr bgcolor="#FFFFFF">
          <td height="30"><div align="center" ><%=form.getId_affiche()%></div></td>
          <td><div align="center"><%=form.getAffiche_name()%></div></td>
          <td><div align="center"><%=form.getCreat_time()%></div></td>
          <td><div align="center" ><a href="afficheAction.do?action=4&id=<%=form.getId_affiche()%>">修改</a>&nbsp;&nbsp;<a href="afficheAction.do?action=6&id=<%=form.getId_affiche()%>">查询内容</a>&nbsp;&nbsp;<a href="javascript:deleteAffiche('<%=form.getId_affiche()%>')">删除</a></div></td>
      <%}%>  </tr>
      </table>
	  <br>
