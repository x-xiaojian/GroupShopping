...
<jsp:useBean id="dao" scope="page" class="com.tg.dao.ManagerDao"/>
<% 
...
<table width="788" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
        ...
        <br>
<form name="form" method="post" enctype="multipart/form-data" action="managerAction.do?action=5&id=<%=form.getId_manager()%>&password=<%=form.getPassword()%>" onSubmit="return checkEmpty(form)">
