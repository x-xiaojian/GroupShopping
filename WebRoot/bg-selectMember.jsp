...
%>
 ...
 function deleteMember(date) {
  if(confirm("确定要删除吗？")){
    window.location="memberAction.do?action=3&id="+date;
	}
  }
 </script>
<html>
...
<table width="788" border="0" align="center" cellpadding="0" cellspacing="0">
 <tr>
    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
	    ...
	    <table width="84%"  border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#CCCCCC">
	    ...
	    <tr>
          ...
          <td width="14%"><div align="center">会员姓名</div></td>
           <td width="14%"><div align="center">会员生日</div></td>
    ...
    <td width="38%"><div align="center">操作</div></td>
      ...
      MemberForm form=(MemberForm)list.get(i);
          %>
        <tr bgcolor="#FFFFFF">
          <td height="30"><div align="center"><%=form.getId_member()%></div></td>
          <td><div align="center"><%=form.getUsename()%></div></td>
          <td><div align="center"><%=form.getName()%></div></td>
          <td><div align="center"><%=form.getBirthdate()%></div></td>
        <td><div align="center">

		 <a href="memberAction.do?action=4&id=<%=form.getId_member()%>">详细信息</a>&nbsp;&nbsp;&nbsp;&nbsp;

		 <a href="javascript:deleteMember('<%=form.getId_member()%>')">删除</a>
